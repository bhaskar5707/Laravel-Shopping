      ...
      <div class="collapse navbar-collapse js-navbar-collapse">
        ...
        @foreach($mainCategories as $cat)
            ...
            <ul class="dropdown-menu mega-dropdown-menu">
              ...
              <li class="col-sm-3">
                <ul>
                  ...
                  <li class="dropdown-header"><a href="{{ asset('/products/'.$subcat->url) }}">{{ $subcat->name }}</a></li>
                  @foreach($subcat->categories as $subcat2)
                   <li><a href="{{ asset('/products/'.$subcat2->url) }}">{{ $subcat2->name }}</a></li>
                  @endforeach
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">All Main Category <span class="caret"></span></a>
